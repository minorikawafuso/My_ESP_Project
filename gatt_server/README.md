...
此example基于ESP-IDF的GATT Server Example，在原有的GATTS上加上了基于TCP协议配网的功能。

--2022.11.25--V0.1--
加入了基于TCP协议WiFi配网的功能，使用方法如下：
1. 烧录程序到开发板
2. 打开手机蓝牙调试App，找到名字是"ESP_GATTS_DEMO"的设备并连接，这时可以进行写入或读取数据
3. 电脑或手机打开网络调试助手，连接WiFi，SSID: MY_AP，密码: 12345678
4. 网络调试助手选择TCP Client，主机地址为192.168.4.1:8964
5. 在另一台设备打开无线热点，安全性选择"无"，SSID设为
6. 在TCP Client发送无线热点的SSID到主机，ESP会自动连接到第五步开启的无线热点
